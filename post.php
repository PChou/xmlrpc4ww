...
<html>
	...
	<body>
		...
		<form method='post'>
			<table>
				<tr><td>文件名</td><td><input tyep='text' name='filename' <?php echo "value='$filename'" ?> /></td></tr>
				<tr><td>标题</td><td><input tyep='text' name='title' readonly <?php echo "value='$title'" ?> /></td></tr>
				<tr><td>layout</td><td><input tyep='text' name='layout' <?php echo "value='$layout'" ?> /></td></tr>
				<tr><td>简述</td><td><textarea tyep='text' name='description' row='10'><?php echo $description; ?></textarea></td></tr>
				<tr><td>指纹图片</td><td><input tyep='text' name='thumbimg' <?php echo "value='$thumbimg'" ?> /></td></tr>
				<tr><td>分类</td><td><input tyep='text' name='categories' <?php echo "value='$categories'" ?> /></td></tr>
				<tr><td>标签</td><td><input tyep='text' name='tags' <?php echo "value='$tags'" ?> /></td></tr>
